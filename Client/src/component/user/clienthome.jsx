            ...
            <Sider collapsible collapsed={collapsed} onCollapse={toggle} style={{backgroundColor:'#90EE90'}}>
                ...
                <Menu theme="light" defaultSelectedKeys={['1']} mode="inline" style={{backgroundColor:'#90EE90'}}>
                    <Menu.Item key="1" icon={<UserOutlined />}>
                       <a href="/clienthome/clientprofile">
                       Profile
                        </a> 
                    </Menu.Item>
                    <Menu.Item key="2" icon={<AppstoreOutlined />}>
                    <a href="/clienthome/viewdev">
                        View Developers
                        </a>
                    </Menu.Item>
                    <Menu.Item key="3" icon={<DollarOutlined />}>
                    <a href="/clienthome/pay">
                        Make Pay
                        </a>
                    </Menu.Item>
                    <Menu.Item key="4" icon={<FileTextOutlined />}>
                    <a href="/clienthome/clientviewstatus">
                        View Project
                        </a>
                    </Menu.Item>
                    <Menu.Item key="5" icon={<MessageOutlined />}>
                    <a href="/clienthome/clifeedbk">
                        Add Feedback
                        </a>
                    </Menu.Item>
                    <Menu.Item key="6" icon={<CommentOutlined />}>
                    <a href="/clienthome/clicmp">
                        Add Complaint
                        </a>
                    </Menu.Item>
