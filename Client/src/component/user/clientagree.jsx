                ...
                <Container className="ct">
                    ...
                    <Row className='border shadow justify-content-center p-5 mt-2 rounded'>
                         ...
                         <Form.Group as="Col">
                            ...
                            <Form.Control type='text' name='cname'placeholder='Enter  your name to deal with the developer' onChange={(e) => setValue(e.target.name, e.target.value)} isInvalid={!!errors.cname} />
                            <Form.Control.Feedback type='invalid'>
                                {errors.cname}
                            </Form.Control.Feedback>                       
                             </Form.Group>
                            ...
                            <Form.Control type='text' name='dname'placeholder='Enter the name of the developer' onChange={(e) => setValue(e.target.name, e.target.value)} isInvalid={!!errors.dname} />
                            <Form.Control.Feedback type='invalid'>
                                {errors.dname}
                            </Form.Control.Feedback>                        
                            </Form.Group>
                            ...
                            <Form.Control type='date' name='deadline'placeholder='Enter the type of project you want' onChange={(e) => setValue(e.target.name, e.target.value)} isInvalid={!!errors.deadline} />
                            <Form.Control.Feedback type='invalid'>
                                {errors.deadline}
                            </Form.Control.Feedback>                        
                            </Form.Group>
